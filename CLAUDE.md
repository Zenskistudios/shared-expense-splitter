...
- `.claude/skills/django/SKILL.md` — Django Backend Conventions
- `.claude/skills/django-rest-advanced/SKILL.md` — Advanced Django REST Framework
- `.claude/skills/api-documentation/SKILL.md` — API Documentation
- `.claude/skills/backend-modularization/SKILL.md` — Backend Modularization
