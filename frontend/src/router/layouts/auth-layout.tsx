    ...
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-primary text-primary-foreground p-10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold">Shared expense splitter</span>
        </div>
        ...
        <p className="text-sm text-primary-foreground/50">
          &copy; {new Date().getFullYear()} Shared expense splitter. All rights reserved.
        </p>
      </div>
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between p-6 lg:p-8">
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <span className="font-semibold">Shared expense splitter</span>
          </div>
